...
const Hero = () => {
  return (
    <section className="relative w-full h-screen mx-auto">
      ...
      max-w-7xl mx-auto flex flex-row items-start gap-5`}>
        ...
        <div>
          ...
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            ...
            interfaces and perform business analytics.
          </p>
        </div>
      </div>
      ...
      <div className="absolute xs:bottom-5 bottom-16 w-full
      flex justify-center tems-center">
        <a href="#about">
          <div className="w-[30px] h-[55px] rounded-3xl border-4 border-secondary
  ...
  return (
    <section className="relative w-full h-screen mx-auto">
      ...
      <div>
          ...
          className="text-[#915eff]">Victor</span></h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            I develop web systems, user <br className="sm:block hidden"/>
            interfaces and perform business analytics.   <span className={`${styles.sectionSubText}text-[#915eff]`}>Scroll or Swipe to begin</span>
          </p>
        </div>     
      </motion.div>
